...
async function saveToDB(data) {
    ...
    client.connect();
    client.query('CREATE TABLE IF NOT EXISTS change_lead_time(\n' +
        '                        repo TEXT NOT NULL,\n' +
        '                        commit TEXT NOT NULL PRIMARY KEY,\n' +
        '                        committed_at TIMESTAMP NOT NULL,\n' +
        '                        deployed_at TIMESTAMP NOT NULL,\n' +
        '                        deployment_build_id TEXT NOT NULL\n' +
        ');')

    const text = 'INSERT INTO change_lead_time(repo, commit, committed_at, deployed_at, deployment_build_id) VALUES($1, $2, $3, $4, $5) ON CONFLICT DO NOTHING';

    each(data, d =>
        client.query(text, [d.repository, d.commit, formatTime(d.committed_at), formatTime(d.deployed_at), d.deploy_build])
    );
}
